...
const ActiveStorageUpload = require('@buck3000/uppy-activestorage-upload')
...
```bash
yarn add https://github.com/buck3000/uppy-activestorage-upload
or
npm install https://github.com/buck3000/uppy-activestorage-upload --save
```
